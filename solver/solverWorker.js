        ...
        if (mode === "fmc" || mode === "optimal") {
          ...
          const fmcResult = await withTimeout(
            solveWithFMCSearch(scramble, onProgress, {
              maxPremoveSets: isOptimalMode ? 54 : 12,
              timeBudgetMs: isOptimalMode ? 100000 : 22000,
              sweepBudgetMs: isOptimalMode ? 56000 : 9000,
              ...
              directPhaseAttemptTimeoutMs: isOptimalMode ? 6500 : 3200,
              directStageBudgetMs: isOptimalMode ? 26000 : 7000,
              nissStageBudgetMs: isOptimalMode ? 26000 : 7000,
              ...
              sweepPhaseAttemptTimeoutMs: isOptimalMode ? 2600 : 1400,
              sweepAttemptBudgetMs: isOptimalMode ? 2600 : 1400,
              sweepCfopPerColorTimeoutMs: isOptimalMode ? 900 : 800,
              verifyLimit: isOptimalMode ? 42 : 20,
              enableInsertions: true,
              insertionCandidateLimit: isOptimalMode ? 5 : 2,
              ...
              insertionTimeMs: isOptimalMode ? 24000 : 4500,
              crossColors: ["D"],
            }),
            FMC_333_TIMEOUT_MS,
