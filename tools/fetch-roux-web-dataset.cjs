...
const SOURCES = Object.freeze({
  ...
  // LSE is represented as EO + ELL sets in public alg DBs.
  LSE: [
...
function buildOutput({ cmll, lse, sourceMeta, generatedAt }) {
  const lines = [];
...
async function main() {
  ...
  const outputCode = buildOutput({
    ...
    sourceMeta: cmllResult.sourceMeta.concat(lseResult.sourceMeta),
    generatedAt,
  });
