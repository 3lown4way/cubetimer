...
assert.equal(enforceBenchmarkNoFallback({
  config: { mode: "fmc", fmcQualityMode: "extreme", fmcTargetMoveCount: 20 },
  result: { ok: true, source: "FMC_WASM", qualityMode: "extreme", extremeProfileId: "independent-frontier-v2-compression-first-24", qualityTargetReached: false, qualityDowngraded: false, moveCount: 22 },
}).reason, "FMC_EXTREME_TARGET_NOT_REACHED");
assert.equal(enforceBenchmarkNoFallback({
  config: { mode: "fmc", fmcQualityMode: "extreme", fmcTargetMoveCount: 20 },
  result: { ok: true, source: "FMC_WASM", qualityMode: "extreme", extremeProfileId: "independent-frontier-v2-compression-first-24", qualityTargetReached: true, qualityDowngraded: false, moveCount: 20 },
}).ok, true);
