...
export const append_minmove_333_bundle_gzip_chunk: (a: number, b: number) => [number, number, number];
export const begin_minmove_333_bundle: (a: number) => [number, number];
...
export const finish_minmove_333_bundle: (a: number) => [number, number];
...
export const prepare_twophase_333_from_cubie_json: (a: number, b: number, c: number, d: number) => [number, number];
